...
class ETHgraph(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        random_start_number = float(randint(120,140))
        ethereum_historic.append(random_start_number)

        for element in range(0,100):
            random_new_element = float(randint(-3,3))
            ethereum_historic.append(random_new_element + ethereum_historic[-1])
        
        f = Figure(figsize=(5,5), dpi=100)
        a = f.add_subplot(111)
        a.plot(ethereum_historic, "#7f7fff")
               
        a.set_title("Ethereum Simulated Chart")
        a.set_ylabel("Price in Dollars")
...
class XRPgraph(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        random_start_number = float(randint(300,400))/1000
        ripple_historic.append(random_start_number)

        for element in range(0,100):
            random_new_element = float(randint(-5,5))/1000
            ripple_historic.append(random_new_element + ripple_historic[-1])
        
        f = Figure(figsize=(5,5), dpi=100)
        a = f.add_subplot(111)
        a.plot(ripple_historic, "#7f7fff")
        
        a.set_title("Ripple Simulated Chart")
        a.set_ylabel("Price in Dollars")
        a.set_xlabel("Iterations (Updates Every time the app opens!)")
...
class SUBgraph(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        random_start_number = float(randint(4000,4400))/100000
        substratum_historic.append(random_start_number)

        for element in range(0,100):
            random_new_element = float(randint(-50,50))/100000
            substratum_historic.append(random_new_element + substratum_historic[-1])
        
        f = Figure(figsize=(5,5), dpi=100)
        a = f.add_subplot(111)
        a.plot(substratum_historic, "#7f7fff")
        
        a.set_title("Substratum Simulated Chart")
        a.set_ylabel("Price in Dollars")
        a.set_xlabel("Iterations (Updates Every time the app opens!)")       
