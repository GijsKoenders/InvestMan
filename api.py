...
#https://www.bitmex.com/app/wsAPI for more details and a list of methods
#websocket-apikey-auth-test.py
#Reference Python implementation for authorizing with websocket.

#real keys, real secret
API_KEY = "4VS-Xlg2hEdGHIcbR24wXxzV"
API_SECRET = "FFKVocjwtvRjlfRMtm8-GCe1alzz0pDD2anGPUVf8v7YEJmD"
