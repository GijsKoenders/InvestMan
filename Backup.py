...
def signupscreen ():
    ...
    Confirmbut = Button (root, text = "Confirm", command = return_entry)
...
def Loginscreen ():
    ...
    Loginbut = Button (root, text = "Go!", command = return_entry)
...
def Toolbar (root):
    "Creating a toolbar"
    toolbar = Frame (root)
    Logoutbut = Button (toolbar, text = "Log out", bg = "red", fg= "white", command = lambda: MessageboxAuto (root)) 
