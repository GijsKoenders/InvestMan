...
def substratum_minute():
    ...
    axes.plot(substratum_minute_list, linewidth =1)
    axes.plot(substratum_minute_list_h, "#00870b", linewidth =0.5)
    axes.plot(substratum_minute_list_l, "#ff0000", linewidth =0.5)
...
def substratum_fifteen():
    ...
    axes = fig.add_axes([0.1,0.1,0.8,0.8])
    axes.plot(substratum_fifteen_list, linewidth =1)
    axes.plot(substratum_minute_list_h, "#00870b", linewidth =0.5)
    axes.plot(substratum_minute_list_l, "#ff0000", linewidth =0.5)
...
def substratum_hour():
    ...
    axes = fig.add_axes([0.1,0.1,0.8,0.8])
    axes.plot(substratum_hour_list, linewidth =1)
    axes.plot(substratum_minute_list_h, "#00870b", linewidth =0.5)
    axes.plot(substratum_minute_list_l, "#ff0000", linewidth =0.5)
...
def substratum_4hour():
    ...
    axes = fig.add_axes([0.1,0.1,0.8,0.8])
    axes.plot(substratum_4hour_list, linewidth =1)
    axes.plot(substratum_minute_list_h, "#00870b", linewidth =0.5)
    axes.plot(substratum_minute_list_l, "#ff0000", linewidth =0.5)
